...
<style>
    ...
    /* 振り直しボタン：赤 */
    div.stButton > button[key^="reroll"] { background-color: #FF4B4B !important; color: white !important; font-weight: bold !important; }
    /* ドロー・リセット：青 */
    div.stButton > button[key^="draw"], div.stButton > button[key^="reset"] { background-color: #1E90FF !important; color: white !important; }
    /* 攻撃ボタン：オレンジ */
    div.stButton > button[key^="atk_"] { background-color: #FFA500 !important; color: black !important; font-weight: bold !important; border: 1px solid white; }
